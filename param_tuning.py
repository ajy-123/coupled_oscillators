...
parser.add_argument('--eps', type=float,
                    help='Coupling Constant epsilon')
parser.add_argument('--p', type=float,
                    help='Small World Connection Probability')
...
Directory setup
"""
sim_dir = '/home/ayeung_umass_edu/nv-nets/results/%d-ring-dataset-eps-%.2f-p-%.2f' % (size, eps, p)
...
"""
train_dataset = []
n = CoupledOscillator(n_rings=size, eps = eps, p = p)
for img in train_X:
    n.initialize()
